# This program determines the award to given to each participant.
# The awards are: 'Provincial colours', 'Provincial Half Colours', 'Provincial Scroll', 'No Award'.
# The award will then print out each participant and their corresponding awards.

# **************************************PART A*********************************************************8
# This section of the progran the user Inputs: Enter participants details. Input validations includes;
# letters only; no null entry; no characters less than 2; no characters more than 20 and no spaces.

# ***User input of participant details***
